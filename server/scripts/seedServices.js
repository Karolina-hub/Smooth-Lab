...
const services = [
    ...
    // Электроэпиляция
    { method: 'Электроэпиляция', title: '1 час работы',          price: 50,  zone: 'Тело', description: 'Стоимость одного часа работы специалиста.' },
    { method: 'Электроэпиляция', title: 'До 30 минут (за мин.)', price: 1.2, zone: 'Тело', description: 'Стоимость за минуту при сеансе до 30 минут.' },
    { method: 'Электроэпиляция', title: 'Одноразовая игла',      price: 7,   zone: 'Тело', description: 'Одноразовая игла для электроэпиляции.' },
];
